...
import com.fairpay.payment.providers.qiwi.fieldScope.Views;
...
public class PayController {
    ...
    @Autowired
    public PayController(com.fairpay.payment.providers.qiwi.service.interf.IBillProcessingService IBillProcessingService) {
