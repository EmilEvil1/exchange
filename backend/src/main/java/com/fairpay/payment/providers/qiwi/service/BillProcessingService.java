package com.fairpay.payment.providers.qiwi.service;

import com.fairpay.payment.providers.configs.ApplicationConfigs;
import com.fairpay.payment.providers.error.QiwiUpdateStatusException;
import com.fairpay.payment.providers.qiwi.controllers.QiwiResponse;
import com.fairpay.payment.providers.qiwi.misc.Utils;
...
public class BillProcessingService implements IBillProcessingService {
    ...
    private final com.fairpay.payment.providers.qiwi.service.interf.IBillService IBillService;
