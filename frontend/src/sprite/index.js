...
<svg xmlns="//www.w3.org/2000/svg" style="z-index:-99999;position:fixed;top:-99999px;left:-99999px;visibility:hidden;opacity:0;">
  <symbol id="icon-blank-id" viewBox="0 0 40 40">
	<title>icon-blank-id</title>
...
<symbol id="icon-fairpay-ok" viewBox="0 0 40 40">
	<title>icon-fairpay-ok</title>
	<circle fill="#282828" cx="20" cy="20" r="19"/>
	<path fill="#F2B92B" d="M15.5,31.5C15.4,31.5,15.4,31.5,15.5,31.5c-1.1,0-2-0.5-2.6-1.4L8.1,23c-0.5-0.7-0.3-1.7,0.4-2.2s1.7-0.3,2.2,0.4l4.8,7L29.3,9.4c0.5-0.7,1.5-0.9,2.2-0.3c0.7,0.5,0.9,1.5,0.3,2.2L18,30.2C17.4,31,16.4,31.5,15.5,31.5z"/>
</symbol>

<symbol id="icon-growth-chart" viewBox="0 0 40 40">
...
<symbol id="icon-logo" viewBox="0 0 140 30">
    ...
    <rect x="1" y="0.5" fill="#F2B92B" width="29.1" height="29.1"></rect>
    <path fill="#F2B92B" d="M37.5,0.6h12.5v3.9h-8.4v8.6h7.4V17h-7.4v12.3h-4.1V0.6z"></path>
    <path fill="#F2B92B" d="M61.2,29.4l-1.4-6.2h-5.3l-1.4,6.2h-4.1l6.3-28.8H59l6.3,28.8H61.2z M57.1,8.6L55,19.5h4.4L57.1,8.6z"></path>
    <path fill="#F2B92B" d="M72.9,0.6v28.8h-4.1V0.6H72.9z"></path>
    <path fill="#F2B92B" d="M83.3,0.6c2.1,0,5.1-0.1,7.1,2.3c0.9,1.2,1.5,2.9,1.5,5V10c0,1.9-0.7,3.6-1.5,4.6c-0.6,0.7-1.4,1.2-2.2,1.5l4.5,13.3h-4.3l-4-12.4H82v12.4h-4.1V0.6H83.3z M82,13.2h2.3c0.9,0,1.8-0.2,2.5-0.9c0.8-0.8,0.9-1.5,0.9-2.6V7.7c0-1.1-0.4-2.1-0.9-2.6C86,4.2,85,4.3,84.1,4.3H82V13.2z"></path>
    <path fill="#F2B92B" d="M96.2,0.6h6.1c1.8,0,3.9,0.1,5.8,1.9c1.9,1.9,2.1,4.4,2.1,6.6v0.8c0,1.6-0.2,4-1.8,5.8c-1.7,1.9-3.9,2.3-5.7,2.3h-2.4v11.4h-4.1V0.6z M100.3,14.3h2.2c0.8,0,1.9-0.1,2.8-1.1c0.9-0.9,0.8-1.9,0.8-3V8.4c0-1,0-2.4-1.1-3.3c-0.9-0.8-2.1-0.7-3.2-0.7h-1.4V14.3z"></path>
    <path fill="#F2B92B" d="M120.4,29.4l-1.4-6.2h-5.3l-1.4,6.2h-4.1l6.3-28.8h3.6l6.3,28.8H120.4z M116.3,8.6l-2.1,10.9h4.4L116.3,8.6z"></path>
    <path fill="#F2B92B" d="M133,17.2v12.1h-4.1V17.1l-6-16.5h4.5l3.6,11.4h0.2l3.5-11.4h4.4L133,17.2z"></path>
</symbol>
...
<symbol id="icon-ok" viewBox="0 0 40 40">
	<title>icon-ok</title>
	<path fill="currentColor" d="M15.5,31.5C15.4,31.5,15.4,31.5,15.5,31.5c-1.1,0-2-0.5-2.6-1.4L8.1,23c-0.5-0.7-0.3-1.7,0.4-2.2s1.7-0.3,2.2,0.4l4.8,7L29.3,9.4c0.5-0.7,1.5-0.9,2.2-0.3c0.7,0.5,0.9,1.5,0.3,2.2L18,30.2C17.4,31,16.4,31.5,15.5,31.5z"/>
</symbol>

<symbol id="icon-output-money" viewBox="0 0 40 40">
...
<symbol id="icon-phone" viewBox="0 0 40 40">
	...
	<circle fill="currentColor" cx="20" cy="20" r="19"></circle>
	<path fill="#282828" d="M17.3,8.6c0.5,0.3,0.9,0.8,0.9,1.4c0.3,1.2,0.5,2.4,0.7,3.6c0,0.2,0,0.4,0,0.6c0.1,0.5-0.3,1-0.7,1.2l-1,0.4c-0.3,0.1-0.6,0.4-0.6,0.7c-0.1,0.5-0.1,1,0,1.4c0.8,2.6,2.3,4.9,4.3,6.8c0.4,0.4,0.8,0.7,1.3,1c0.3,0.2,0.6,0.2,1,0.2c0.2,0,0.5-0.2,0.6-0.4l0.6-0.9c0.2-0.5,0.9-0.8,1.4-0.5c0,0,0.1,0,0.1,0.1c0.3,0.2,0.7,0.4,1,0.6l1.9,1.1l0.5,0.3c0.5,0.3,0.8,0.8,0.8,1.3v0.5c-0.1,0.3-0.3,0.7-0.4,1c-0.6,1.4-1.9,2.4-3.4,2.6c-0.3,0-0.6,0-0.9,0l-0.7-0.1c-0.3-0.1-0.6-0.2-0.8-0.3c-1.4-0.6-2.6-1.5-3.7-2.6c-1.3-1.3-2.5-2.7-3.5-4.3c-1.3-1.9-2.5-3.9-3.3-6c-0.5-1.2-0.8-2.5-0.9-3.8c0-0.4,0-0.8,0-1.2l0.1-0.8c0,0,0-0.1,0-0.2c0.3-1.7,1.6-3.1,3.3-3.6c0.4-0.1,0.8-0.1,1.2-0.2L17.3,8.6z"></path>
</symbol>
<symbol id="icon-rocket" viewBox="0 0 40 40">
